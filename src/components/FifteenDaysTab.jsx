  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="bg-[#111827] rounded-3xl p-10 py-12 border border-slate-800 shadow-xl mb-6 relative">
        <h3 className="text-[17px] font-extrabold tracking-wide text-white text-center mb-14">15 Days Comparison (1st-15th)</h3>
        ...
        <div className="flex justify-between items-start w-full relative z-10">
          <div className="text-left w-1/3">
            ...
            <p className="text-[32px] font-extrabold text-white">₱{prev15Total.toLocaleString(undefined, {minimumFractionDigits: 2})}</p>
          </div>
          ...
          <div className="text-right w-1/3">
            ...
            <p className="text-[32px] font-extrabold text-white">₱{curr15Total.toLocaleString(undefined, {minimumFractionDigits: 2})}</p>
          </div>
        </div>
