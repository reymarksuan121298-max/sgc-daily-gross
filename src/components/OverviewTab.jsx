      ...
      <div className="bg-cardBg rounded-2xl p-6 border border-border-divider shadow-lg relative overflow-hidden">
        ...
        <div className="flex justify-between items-center mb-8 relative z-10">
          ...
          <div className="flex items-center gap-2 text-sm text-textSecondary">
            ...
            {currentPage === 'imp' ? 'Imperial' : currentPage === 'setb' ? 'SETB' : currentPage === 'iligan' ? 'Iligan' : currentPage === 'lanao' ? 'Lanao' : currentPage === 'lotto' ? 'Lotto' : currentPage === 'baloi' ? 'Baloi' : currentPage === 'lds' ? 'LDS' : currentPage === 'mandaue' ? 'Mandaue' : 'Mag'} Aggregate Trend
          </div>
        </div>
